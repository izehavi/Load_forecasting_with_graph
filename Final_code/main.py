...
# Test the GraphScalarAnalyzer class
for i in range(len(L_path_to_W)):
    graph_scalar = GraphScalarAnalyzer(dictGraphs["Graphs" + str(i)] , nodes_features, name_column, row , **df_pos)
...
from Graph_constructor.graph_scalar_analyzer import GraphAnalyzer
